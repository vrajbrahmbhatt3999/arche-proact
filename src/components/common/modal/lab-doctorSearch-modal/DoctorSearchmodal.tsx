...
import { doctorModalHeaderData } from "../../../../constants/table-data/labInvoiceTabledata";
...
const DoctorSearchmodal: FC<IDoctorModal> = ({
  setModelOpenClose,
  handleRowClick,
  handleClose,
}) => {
  ...
  console.log(doctorListDataObject,"doctoprDaata")
