...
//   handleBackspace?: (e: React.KeyboardEvent<HTMLInputElement>) => any;
//   length: number;
// }

// const OtpInput: FC<IOtpInput> = ({ length }) => {
...
//     if (e.keyCode === 8 && index > 0 && !e.currentTarget.value) {
//       inputRefs[index - 1]?.current?.focus();
//     }
//   };
//   return (
...
import { RE_DIGIT } from "../../../constants/constant";
