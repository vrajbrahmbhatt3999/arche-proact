...
const ViewJobs = () => {
  ...
  const { viewJobs, showAddResultPopup, showNotes, isLoading } = useAppSelector(
    (state) => state.labsJob
  );
    ...
    <>
      ...
      {viewAttachmentsPopup && (
        <Popup
          ...
          handleClose={() => setViewAttachmentsPopup(false)}
          popData={attachment}
        />
      )}
      {/* View Results Popup */}
