...
import { setAllMobileAppointmentPayloadData } from '../../../redux/features/mobile-appointment-request/mobileAppointmentRequestSlice'
...
const MobileAppoinmentRequestModalV2: FC<IMobileAppointmentRequestModal> = ({
  handleClose,
  handleSubmit,
  handleOpen,
  appointmentIds,
  ...
  // console.log("mobileAppointmentReqeustData", mobileAppointmentReqeustData);
  ...
  useEffect(() => {
    if (appointmentIds && appointmentIds?.length > 0) {
      let payloadData = {
        ...
        appointment_requests: appointmentIds || [],
      }
      // console.log("payloadData", payloadData);

      // dispatch(setAllMobileAppointmentPayloadData(payloadData))
      dispatch(
        getAllMobileAppointmentCalander(requestGenerator(payloadData))
        ...
        <div className={styles.mobileAppointmentContainer}>
          <div className={styles.searchReloadIconContainer}>
            <div className={styles.searchIconContainer}>
              ...
              {/* <Search
              placeHolder={"Search"}
              setSearchMedicalCenter={setMobileAppointmentSearch}
            ...
            /> */}
              <SmartSearch
                ...
                customClassInput={styles.mobileAppointmentSearch}
                // isDisable={
                //   (doctorSearch && doctorSearch?.length > 0) ||
...
export default MobileAppoinmentRequestModalV2
